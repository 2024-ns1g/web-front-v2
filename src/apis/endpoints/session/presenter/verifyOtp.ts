...
export const verifyPresenterOtp = async (apiClient: AxiosInstance, log: any, _state: StateContextType, params: VerifyOtpRequest) => {
  const response = await apiClient.post('/session/presenter/verify', params);
